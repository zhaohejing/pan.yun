...
{
    [AbpAuthorize]
    public class ChatMessageManager : YunDomainServiceBase, IChatMessageManager
    {
        ...
        public async Task SendMessageAsync(UserIdentifier sender, UserIdentifier receiver,
            string message, string senderTenancyName, string senderUserName, string headImage)
        {
            ...
            string senderTenancyName, string senderUserName, string headImage)
        {
            ...
            var senderAsFriend = receiverCacheItem?.Friends.FirstOrDefault(f => f.FriendTenantId ==
            sender.TenantId && f.FriendUserId == sender.UserId);
            ...
            if (senderAsFriend.FriendTenancyName == senderTenancyName &&
                ...
                senderAsFriend.HeadImage.Equals(headImage))
            {
                return;
            }
            ...
            friendship.HeadImage = headImage;
